...
#define APP_TIMER_MAX_TIMERS            (2 + 5+ BSP_APP_TIMERS_NUMBER)                 /**< Maximum number of simultaneously created timers. */
...
#define EVENT_SIZE						sizeof(app_timer_event_t)
...
int main(void)
{
    ...
    APP_SCHED_INIT(EVENT_SIZE, QUEUE_SIZE );
